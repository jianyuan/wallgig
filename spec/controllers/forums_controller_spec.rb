  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved forum as @forum" do
        ...
        post :create, {:forum => { "group" => "invalid value" }}, valid_session
        assigns(:forum).should be_a_new(Forum)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested forum" do
        ...
        Forum.any_instance.should_receive(:update).with({ "group" => "" })
        put :update, {:id => forum.to_param, :forum => { "group" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the forum as @forum" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Forum.any_instance.stub(:save).and_return(false)
        put :update, {:id => forum.to_param, :forum => { "group" => "invalid value" }}, valid_session
        assigns(:forum).should eq(forum)
      end
